...
function PlayState:enter(params)
	...
	self.player:changeState('falling', {Momentum = PLAYER_WALK_SPEED})
...
function PlayState:render()
	...
	if self.player.key > 0 then
		...
		love.graphics.draw(gTextures['keys-and-locks'], gFrames['keys-and-locks'][self.player.key], VIRTUAL_WIDTH - 22, 0)
	elseif self.player.goal > 0 then
		love.graphics.setColor(255, 255, 255, 255)
		love.graphics.draw(gTextures['flags'], gFrames['flags'][self.player.goal], VIRTUAL_WIDTH - 22, 4)
	end
end
